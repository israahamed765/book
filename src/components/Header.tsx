...
import { Search, Bell, Sparkles, X, Menu } from 'lucide-react';
...
export default function Header({ onOpenQuickAdd }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 right-0 z-30 w-full lg:w-[calc(100%-16rem)] flex justify-between items-center h-20 px-4 md:px-10 bg-[#faf9f740] backdrop-blur-md border-b border-white/20 ml-0 lg:ml-64">
      ...
      {/* Simulated Time Engine / Virtual Clock Status Display */}
      ...
      <div className="flex items-center gap-2 sm:gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <img
            ...
            alt="User profile"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuATc3Qz8BeFVIxWBQqzLKSoJRR-zQiVRDXkA42S5vlWapO7pyxnMUYwYKWsZx0NJArJPEqXe1SrItocs4PqPgP1Yt6qmyvVmQS8Atohk0unA1ItuM1X88xSVm77alSnqWMuhkXCDJyNAPCCj5YuIBE-zFJuKx1MSPmMX0pHuiN58PL0M05vbzDixCaJUsscwpM5d24Bb3kpKfVX3D7RHccc0ajLzzhMKGPcOiihrRqSmfjGmToeRKwP1XlSOFPkK0uvl0qtxy3M2mM"
