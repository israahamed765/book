...
// import { User, Mail, Save, Sparkles, AlertCircle, Settings, Camera } from 'lucide-react';
...
//       reader.onloadend = () => {
//         // Update the preview state with base64 string
...
//                 />
//               ) : (
//                 <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center text-primary/70 border-4 border-white shadow-md">
...
//                 <h4 className="font-sans text-sm font-bold text-on-surface">Profile Picture</h4>
//                 <p className="font-sans text-xs text-on-surface-variant mt-0.5 max-w-sm">
//                     This image will be used for your planner branding and visible across the interface. Standard square formats work best.
//                 </p>
//                 <button 
//                     type="button"
//                     onClick={triggerFileInput}
//                     className="mt-2.5 text-xs font-bold text-primary hover:text-primary/80 transition-colors cursor-pointer"
//                 >
...
import { motion, AnimatePresence } from 'motion/react';
import { User, Mail, Save, Sparkles, Settings, Camera } from 'lucide-react';
...
export default function SettingsView() {
  ...
  // تحديث المعاينة تلقائيًا فور تحميل البيانات من المخزن المحلي
  useEffect(() => {
            ...
            <div className="relative group">
              {avatarPreview ? (
                <img 
                  src={avatarPreview} 
                  alt="Profile Preview" 
                  className="w-20 h-20 rounded-full object-cover border-4 border-white shadow-md/10"
                />
              ) : (
                <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center text-primary/70 border-4 border-white shadow-md/10">
                  <User size={32} strokeWidth={1.5} />
                </div>
              )}
